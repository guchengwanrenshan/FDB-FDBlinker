...
def findBinary(filename):
    ...
    known_path = "/home/zl/app/ADFRsuite_x86_64Linux_1.0/bin/autogrid4"
...
class CalculateAD4Grids:
    ...
    def __init__(self, receptor, center, size, atypes, spacing=0.375,
        ...
        assert(adBin is not None), "CRITICAL: 'autogrid4' not found. Please check your ADFRsuite installation."
